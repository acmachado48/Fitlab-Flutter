...
class _CalendarioState extends State<Calendario> {
  ...
  final List<Map<String, String>> classes = [
    {'name': 'FitDance', 'time': '08:00', 'type': 'Aula Coletiva'},
    {'name': 'Pilates', 'time': '10:00', 'type': 'Aula Coletiva'},
    {'name': 'Spinning', 'time': '14:00', 'type': 'Aula Coletiva'},
    {'name': 'Yoga', 'time': '18:00', 'type': 'Aula Coletiva'},
  ];
